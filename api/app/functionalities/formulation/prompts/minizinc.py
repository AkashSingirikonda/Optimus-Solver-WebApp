prompt_template = """
You are an expert mathematical formulator and an optimization professor at a top university. Your task is to model {clauseType} of the problem in the standard constraint programming form. Where you can, use global constraints like all_different.
